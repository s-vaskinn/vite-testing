    ...
    return (<form className="mb-6">
        <div className="mb-4">
            ...
            <input 
                ...
                value={title}
                onChange={(e) => setTitle(e.target.value)} //pass inn event e
            />
        </div>
        <div className="mb-4">
            ...
            <select 
                ...
                className="w-full p-2 border rounded-lg"
                value={priority}
                onChange={(e) => setPriority(e.target.value)} //pass inn event e
            >
        ...
        <div className="mb-4">
            ...
            <select 
                ...
                className="w-full p-2 border rounded-lg"
                value={category}
                onChange={(e) => setCategory(e.target.value)} //pass inn event e
            >
        ...
        <div className="mb-4">
            ...
            <textarea 
                ...
                className="w-full p-2 border rounded-lg"
                value={description}
                onChange={(e) => setDescription(e.target.value)} //pass inn event e
            ></textarea>
        </div>
